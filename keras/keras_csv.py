...
class Utils():
    def __init__(self):
        ...
        self.source_path = 'd:/dataset/dog/keras/'
    ...
    def set_label(self):
        ...
        print(imgs)
    def read_csv(self):
        filename = self.data_path + 'test_1.csv'
        csv_file = open(self.source_path + 'annotations.csv', 'w', newline='')
        csv_header = ['path','x1','y1','x2','y2','class']
            ...
            for i, row in enumerate(reader):
             if i > 0:  # 第一行从0开始
                ...
                if(op.eq(row[6],'{}') != True):
                    ...
                    path = self.data_path+'train/'+ fname
                    newRow = [path,max(0,xmin),max(0,ymin),xmax,ymax,label]
